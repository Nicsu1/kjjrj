...
# Function to autoplay audio by embedding it in an HTML tag
    ...
    if st.button("Set Alarm"):
        ...
        while True:
            ...
            if current_time == alarm_time.strftime("%H:%M:%S"):
                ...
                get_audio_base64("alert.mp3")  # Play alert sound here
                break
            time.sleep(1)
...
with tabs[1]:
    ...
    def stop_stopwatch():
        ...
        get_audio_base64("alert.mp3")  # Play sound when stopwatch is stopped
...
# TIMER FUNCTIONALITY WITH REPEAT
with tabs[2]:
    st.header("Timer")
    ...
    while st.session_state.timer_running:
        ...
        if st.session_state.timer_running:
            ...
            get_audio_base64("alert.mp3")  # Play sound automatically when timer ends
